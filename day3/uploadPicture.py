...
#有些页面控件是javascript页面加载之后生成的
#点击开始上传，同时三个class定位
time.sleep(2)

driver.find_element_by_name("file").send_keys("D:/abc.png")
#driver.find_elements_by_css_selector(".uploadBtn.state-finish.state-ready").click()
driver.find_element_by_css_selector(".uploadBtn.state-finish.state-ready").click()
time.sleep(3)
driver.switch_to.alert.accept()
#页面太长，点击不了下边的button，怎么向下拉
#range(10)表示0-9十个
